...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: Spacing.LG, paddingVertical: Spacing.MD, backgroundColor: Colors.WHITE, borderBottomWidth: 1, borderBottomColor: Colors.BORDER, alignItems: 'center' },
  headerTitle: { fontSize: 22, fontWeight: '800', color: Colors.PRIMARY },
  headerSubtitle: { fontSize: 14, color: Colors.DARK_GRAY, marginTop: 2 },
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.WHITE, borderRadius: Radius.MD, marginHorizontal: Spacing.LG, marginVertical: Spacing.MD, paddingHorizontal: Spacing.MD, height: 48, borderWidth: 1, borderColor: Colors.LIGHT_GRAY },
  searchIcon: { marginRight: Spacing.SM },
  searchInput: { flex: 1, fontSize: 14, color: Colors.BLACK, textAlign: 'right' },
  container: { flex: 1 },
  threadItem: { flexDirection: 'row-reverse', alignItems: 'center', paddingHorizontal: Spacing.LG, paddingVertical: Spacing.MD, backgroundColor: Colors.WHITE, marginBottom: 1, borderBottomWidth: 1, borderBottomColor: Colors.BORDER },
  threadAvatar: { width: 52, height: 52, borderRadius: 26, backgroundColor: Colors.PRIMARY_LIGHT, alignItems: 'center', justifyContent: 'center', marginLeft: Spacing.MD },
  threadAvatarText: { fontSize: 24 },
  threadInfo: { flex: 1 },
  threadTopRow: { flexDirection: 'row-reverse', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
  ...
  threadBottomRow: { flexDirection: 'row-reverse', justifyContent: 'space-between', alignItems: 'center' },
  threadLastMessage: { fontSize: 13, color: Colors.DARK_GRAY, flex: 1, textAlign: 'right' },
  unreadBadge: { minWidth: 20, height: 20, borderRadius: 10, backgroundColor: Colors.PRIMARY, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 6, marginLeft: Spacing.SM },
  unreadText: { color: Colors.WHITE, fontSize: 11, fontWeight: '700' },
  chatHeader: { flexDirection: 'row-reverse', alignItems: 'center', paddingHorizontal: Spacing.MD, paddingVertical: Spacing.SM + 2, backgroundColor: Colors.WHITE, borderBottomWidth: 1, borderBottomColor: Colors.BORDER },
  backBtn: { width: 36, height: 36, alignItems: 'center', justifyContent: 'center' },
  backArrow: { fontSize: 32, color: Colors.PRIMARY, fontWeight: '300', lineHeight: 36 },
  chatAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: Colors.PRIMARY_LIGHT, alignItems: 'center', justifyContent: 'center', marginLeft: Spacing.SM },
  ...
  messageBubble: { maxWidth: '80%', borderRadius: Radius.MD, paddingHorizontal: Spacing.MD, paddingVertical: Spacing.SM + 2, marginBottom: Spacing.XS },
  messageMe: { backgroundColor: Colors.PRIMARY, alignSelf: 'flex-start', borderBottomRightRadius: 4 },
  messageThem: { backgroundColor: Colors.WHITE, alignSelf: 'flex-end', borderBottomLeftRadius: 4, borderWidth: 1, borderColor: Colors.BORDER },
  ...
  inputBar: { flexDirection: 'row-reverse', alignItems: 'flex-end', backgroundColor: Colors.WHITE, paddingHorizontal: Spacing.MD, paddingVertical: Spacing.SM, borderTopWidth: 1, borderTopColor: Colors.BORDER, gap: Spacing.SM },
  chatInput: { flex: 1, backgroundColor: Colors.SURFACE, borderRadius: Radius.PILL, paddingHorizontal: Spacing.MD, paddingVertical: Spacing.SM + 2, fontSize: 14, color: Colors.BLACK, textAlign: 'right', maxHeight: 100, borderWidth: 1, borderColor: Colors.LIGHT_GRAY },
