...
export default function CartScreen() {
  ...
  const renderPick = (item: CartItem) => (
    <TouchableOpacity
      ...
      onPress={() => addItem({ id: item.id, name: item.name, nameEn: item.nameEn, price: item.price, image: item.image })}
      activeOpacity={0.7}
    >
      <View style={styles.pickImageArea}>
        <Text style={styles.pickImageText} numberOfLines={2}>{item.name}</Text>
      </View>
      ...
      <SafeAreaView style={styles.safe} edges={['top']}>
        <View style={styles.emptyContainer}>
          <View style={styles.emptyIcon}>
            <Ionicons name="cafe-outline" size={44} color={Colors.DARK_GRAY} />
          </View>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.footer}>
          <View style={styles.footerRow}>
            <Text style={styles.footerLabel}>المجموع الفرعي</Text>
            <Text style={styles.footerValue}>{subtotal.toFixed(2)} د.ل</Text>
          </View>
          <View style={styles.footerRow}>
            <Text style={styles.footerLabel}>الضريبة (٨٪)</Text>
            <Text style={styles.footerValue}>{tax.toFixed(2)} د.ل</Text>
          </View>
          ...
          <TouchableOpacity style={styles.checkoutBtn} activeOpacity={0.85}>
            <Text style={styles.checkoutBtnText}>تقديم الطلب</Text>
