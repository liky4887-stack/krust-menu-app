...
export default function OrderConfirmationScreen() {
  ...
  const params = useLocalSearchParams<{
    ...
    fulfillment: string; name: string;
  }>();
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.successCircle}>
          <CheckCircle2 size={56} color={Colors.WHITE} strokeWidth={2} />
        </View>
        ...
        <View style={styles.orderNumberCard}>
          ...
          <Text style={styles.orderNumber}>{params.orderId}</Text>
        </View>
        ...
        <View style={styles.infoCard}>
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoContent}>
              ...
              <Text style={styles.infoValue}>{isPickup ? 'استلام من الفرع' : 'توصيل'}</Text>
            </View>
          </View>
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoContent}>
              ...
              <Text style={styles.infoValue}>{paymentLabels[params.paymentMethod] ?? params.paymentMethod}</Text>
              {params.paymentMethod !== 'cash' && (
                <Text style={styles.infoSub}>رقم العملية: {params.paymentRef}</Text>
              )}
            </View>
          </View>
        </View>
        ...
        {order && (
          <View style={styles.itemsCard}>
            ...
            <View style={styles.totalRow}>
              ...
              <Text style={styles.totalValue}>{params.total} د.ل</Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.actionsRow}>
          ...
          >
            ...
            <Text style={styles.actionText}>عرض طلباتي</Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Text style={styles.actionTextPrimary}>العودة للقائمة</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  successCircle: {
    ...
    shadowColor: Colors.EMERALD_600,
