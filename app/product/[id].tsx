      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.topBar}>
          ...
          <View style={styles.topBarActions}>
            <TouchableOpacity onPress={handleShare} style={styles.iconBtn}><Share2 size={20} color={Colors.PRIMARY} strokeWidth={2} /></TouchableOpacity>
            <TouchableOpacity onPress={() => toggleFavorite(product.id)} style={styles.iconBtn}><Heart size={20} color={isFav ? Colors.RED_500 : Colors.PRIMARY} fill={isFav ? Colors.RED_500 : 'transparent'} strokeWidth={2} /></TouchableOpacity>
          </View>
        </View>
        <View style={styles.imageArea}><Text style={styles.imagePlaceholder} numberOfLines={3}>{product.title}</Text></View>
...
const styles = StyleSheet.create({
  ...
  imageArea: { height: 200, backgroundColor: Colors.PRIMARY_LIGHT, alignItems: 'center', justifyContent: 'center', marginHorizontal: Spacing.LG, borderRadius: Radius.LG, marginBottom: Spacing.MD },
  ...
  metaChip: { flexDirection: 'row-reverse', alignItems: 'center', gap: 6, backgroundColor: Colors.PRIMARY_LIGHT, borderRadius: Radius.SM, paddingHorizontal: Spacing.SM + 2, paddingVertical: Spacing.SM },
  ...
  optionChip: { flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'space-between', backgroundColor: Colors.WHITE, borderRadius: Radius.MD, paddingHorizontal: Spacing.MD, paddingVertical: Spacing.MD, borderWidth: 1.5, borderColor: Colors.BORDER },
  ...
  quantityRow: { flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'space-between', marginTop: Spacing.XL, paddingVertical: Spacing.MD, borderTopWidth: 1, borderTopColor: Colors.BORDER },
  ...
  qtyBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: Colors.WHITE, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: Colors.BORDER },
  ...
  addOnCard: { width: 130, backgroundColor: Colors.WHITE, borderRadius: Radius.CARD, borderWidth: 1, borderColor: Colors.BORDER, overflow: 'hidden' },
  addOnImageArea: { height: 60, backgroundColor: Colors.PRIMARY_LIGHT, alignItems: 'center', justifyContent: 'center' },
  ...
  addOnBottom: { flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: Spacing.SM, paddingBottom: Spacing.SM, paddingTop: 4 },
  addOnPrice: { fontSize: 13, fontWeight: '800', color: Colors.PRIMARY },
  addOnPlusBtn: { width: 24, height: 24, borderRadius: 12, backgroundColor: Colors.PRIMARY, alignItems: 'center', justifyContent: 'center' },
  bottomPadding: { height: 120 },
  footer: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: 'rgba(255,255,255,0.95)', paddingHorizontal: Spacing.LG, paddingTop: Spacing.MD, paddingBottom: Spacing.XL, borderTopWidth: 1, borderTopColor: Colors.BORDER, borderTopLeftRadius: 20, borderTopRightRadius: 20, overflow: 'hidden' },
  addToCartBtn: { backgroundColor: Colors.PRIMARY, borderRadius: Radius.CHIP, paddingVertical: Spacing.MD + 2, alignItems: 'center', justifyContent: 'center' },
